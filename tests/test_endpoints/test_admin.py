...
def test_post(cli_ent,generate_token):
...
def test_post_empty_string(cli_ent, generate_token):
    headers = {'X-APP-SECRET': '{}'.format(generate_token)}
...
def test_post_invalid_values(cli_ent,generate_token):
    headers = {'X-APP-SECRET': '{}'.format(generate_token)}
...
def test_get(cli_ent,generate_token):
    headers = {'X-APP-SECRET': '{}'.format(generate_token)}
...
def test_get_one_product(cli_ent,generate_token):
    headers = {'X-APP-SECRET': '{}'.format(generate_token)}
