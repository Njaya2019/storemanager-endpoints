...
def test_get(cli_ent):
    ...
    assert data== {'Sales':[{'sale_id':1,'attendant_id':2,'product_id':2,'date':'Oct 10, 2018 5:00 P.M','transanction_cost':59.98},
                  {'sale_id':2,'attendant_id':1,'product_id':1,'date':'Oct 10, 2018 6:25 P.M','transanction_cost':100},
...
def test_get_sale_record(cli_ent):
    ...
    data=json.loads(response.data)
    assert data=={'Sale':{'sale_id':2,'attendant_id':1,'product_id':1,'date':'Oct 10, 2018 6:25 P.M','transanction_cost':100}}